...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--model', type=str, default='motion',
                            help='chooses which model to use. motion, test')
        ...
        parser.add_argument('--crop', metavar='pixels',type=int, default=None, help='patch size')
        ...
        parser.add_argument('--spacing', metavar='mm',
                            type=float, default=None, help='resize image to specific voxel spacing')
        ...
        parser.add_argument('--classes', metavar='0 C1 ... CN',
                            type=int, default=[0, 1], nargs='*', help='classes to clasify')
